...
Register-ScheduledTask -TaskName 'SoundControl Device Recovery' -Action $action -Trigger $triggers -Settings $settings -User 'SYSTEM' -RunLevel Highest -Force | Out-Null
