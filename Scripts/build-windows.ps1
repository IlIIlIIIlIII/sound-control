...
& $DotNet publish (Join-Path $root 'Sources\Windows\WinUI\SoundControlWindows.csproj') -c Release -r win-x64 --self-contained true -p:Platform=x64 -o (Join-Path $BuildDirectory 'package\ui')
